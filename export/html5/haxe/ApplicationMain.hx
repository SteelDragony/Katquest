...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadFile("assets/images/background_draft.png");
		loadFile("assets/images/click.png");
		loadFile("assets/images/hover.png");
		loadBinary("assets/images/images-go-here.txt");
		loadFile("assets/images/player.png");
		loadFile("assets/images/standard.png");
		loadFile("assets/images/Untitled-1.png");
		loadFile("assets/images/Untitled-2.png");
		loadFile("assets/images/Untitled-3.png");
		loadFile("assets/images/Untitled-4.png");
		loadFile("assets/images/Untitled1-2.png");
		loadFile("assets/images/Untitled2-3.png");
		loadFile("assets/images/Untitled2-4.png");
