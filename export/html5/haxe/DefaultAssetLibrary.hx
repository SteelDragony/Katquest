...
class DefaultAssetLibrary extends openfl.AssetLibrary {
	...
	public function new() {
		...
		add("assets/images/background_draft.png", IMAGE);
		add("assets/images/click.png", IMAGE);
		add("assets/images/hover.png", IMAGE);
		add("assets/images/images-go-here.txt", TEXT);
		add("assets/images/player.png", IMAGE);
		add("assets/images/standard.png", IMAGE);
		add("assets/images/Untitled-1.png", IMAGE);
		add("assets/images/Untitled-2.png", IMAGE);
		add("assets/images/Untitled-3.png", IMAGE);
		add("assets/images/Untitled-4.png", IMAGE);
		add("assets/images/Untitled1-2.png", IMAGE);
		add("assets/images/Untitled2-3.png", IMAGE);
		add("assets/images/Untitled2-4.png", IMAGE);
